...
class Settings(BaseSettings):
    ...
    # Azure AD (required fields made optional for local testing)
    ...
    # Blob Storage (optional for local testing)
    ...
    # Service Bus (optional for local testing)
    ...
    def alert(self):
        ...
        class Alert:
            def __init__(self, sendgrid_api_key, twilio_account_sid, twilio_auth_token,
                ...
                self.alert_phone_from = alert_phone_from
                self.alert_email_to = alert_email_to
                self.alert_phone_to = alert_phone_to
                self.alert_function_url = alert_function_url
        return Alert(self.sendgrid_api_key, self.twilio_account_sid, self.twilio_auth_token,
